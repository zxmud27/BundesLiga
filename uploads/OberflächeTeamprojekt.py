...
def deinemutter(hurensohn):
   print("duspast")
   if(h)
   erstesTeamButton = tk.Button(frame,image= hurensohn, text="erstes Team",width=10, height=10, fg="white", bg="red",command=newframe)
...
def newframe():
   ...
   BM =  tk.Button(frame2,image=bayernMuenchen,text="FC Bayern München",width=200,height=100,bg="royalblue",command=deinemutter(bayernMuenchen))
   BM.place(relx=0.0,rely=0.0)

erstesTeamButton = tk.Button(frame,image=dortmund, text="erstes Team",width=10, height=10, fg="white", bg="royalblue",command=newframe)
erstesTeamButton.place(relx=0.20,rely=0.52, relwidth=0.2, relheight=0.2)  
#   def buttonclick(team):
#      newWindow.destroy
#      erstesTeamButton.config(image=bayernMuenchen)
#Buttons
#Teamauswahl

  

zweitesTeamButton = tk.Button(frame,image=wolfsburg, text="zweites Team",width=10, height=10, fg="white", bg="royalblue",command=newframe)
