...
def winrateLabels(team1, team2):
   ...
   pWH = tk.Label(frame, text=algo1.getwinRatio(), bg='cornflowerblue') #Übersetzer für team1 und team2
   pWH.place(relx=0.20,rely=0.9, relwidth=0.2, relheight=0.04)
   pDraw = tk.Label(frame, text=algo1.getdrawRatio(), bg='cornflowerblue')
   pDraw.place(relx=0.40,rely=0.9, relwidth=0.2, relheight=0.04)
   pWA = tk.Label(frame, text=algo1.getloseRatio(), bg='cornflowerblue')
