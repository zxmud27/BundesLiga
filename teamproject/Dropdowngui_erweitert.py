...
def matchdayDropDown():
    ...
    click_liga_dropdown.set(liga_dropdown[0])
    ...
    CrawlerButton = tk.Button(
        ...
        fg="white",
        bg='brown4',
        command = lambda: crawler_load(clicked_day_Start,clicked_season_Start,clicked_day_End,clicked_season_End,click_liga_dropdown))
...
def crawler_load(clicked_day_Start,clicked_season_Start,clicked_day_End,clicked_season_End,click_liga_dropdown):
    print(click_liga_dropdown.get())
    crawler_class = teamproject.crawler.DataCrawler()
    crawler_class.getSeasons(int(clicked_day_Start.get()),
                                                int(clicked_season_Start.get()), 
                                                int(clicked_day_End.get()), 
                                                int(clicked_season_End.get()), 
                                                click_liga_dropdown.get())
    teamnames = crawler_class.getNamelist(2019,click_liga_dropdown.get())
    teamDropdown(teamnames)
...
def algorithm_load(input_algorithm):
    if input_algorithm == "Minimaler Algorithmus":
        algo_m = teamproject.minimal_algorithm.minimal_class()
        algo_m.get_minimal_probabilities(team1_menu.get(),team2_menu.get())
    elif input_algorithm == "Poisson Algorithmus":
        algo_p = teamproject.poisson_algorithm.poisson_class()
        algo_p.get_probabilities(team1_menu.get(),team2_menu.get())
...
def staticGUI():
    ...
    startButton = tk.Button(
        ...
        fg="white",
        bg='brown4',
        command = lambda: algorithm_load(click_algo_dropdown.get()))
...
#teamnames = variable.getNamelist(2019,"b1") 
