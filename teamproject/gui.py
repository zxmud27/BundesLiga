...
class GUI:
    ...
    def __init__(self, master,mode):
        ...
        self.pWH = tk.Label(master, text="%", bg=self.backgroundcolor, fg=self.fontcolor,height=3,width=8) 
        self.pWH.place(relx=0.1, rely=0.65)
        draw = tk.Label(master, text="Draw:", bg=self.backgroundcolor, fg=self.fontcolor,height=3,width=8)
        draw.place(relx=0.25, rely=0.6)
        self.pDraw = tk.Label(master, text="%", bg=self.backgroundcolor, fg=self.fontcolor,height=3,width=8)
        self.pDraw.place(relx=0.25, rely=0.65)
        ...
        self.pWA = tk.Label(master, text="%", bg=self.backgroundcolor, fg=self.fontcolor,height=3,width=8)
    ...
    def algorithm_load(self):
        if self.click_algo_dropdown.get() == "Minimal Algorithm   ":
            ...
            self.pWH = tk.Label(self.master, text=str(stats[0]) + "%", bg=self.backgroundcolor, fg=self.fontcolor,height=3,width=8) 
            self.pWH.place(relx=0.1, rely=0.65)
            self.pDraw = tk.Label(self.master, text=str(stats[1]) + "%", bg=self.backgroundcolor, fg=self.fontcolor,height=3,width=8)
            self.pDraw.place(relx=0.25, rely=0.65)
            self.pWA = tk.Label(self.master, text=str(stats[2]) + "%", bg=self.backgroundcolor, fg=self.fontcolor,height=3,width=8)
            self.pWA.place(relx=0.4, rely=0.65)
    ...
    def destroy_for_rebuild(self):
        ...
        self.team1_menu = tk.OptionMenu(self.master, self.click_teams1_dropdown, *teams1_list)
        self.team1_menu.place(relx=0.12, rely=0.265)
        self.click_teams2_dropdown = tk.StringVar()
        self.click_teams2_dropdown.set(teams2_list[1])

        self.team2_menu = tk.OptionMenu(self.master, self.click_teams2_dropdown, *teams2_list)
        self.team2_menu.place(relx=0.315, rely=0.265)
    ...
    def crawler_load_second_time(self):
        self.CrawlerButton_two = tk.Button(
            self.master,
            text="Start Crawler",
            width=25,
            height=2,
            fg=self.fontcolor,
            bg=self.buttoncolor,
            command = lambda: self.destroy_for_rebuild())
        self.CrawlerButton_two.place(relx=0.20, rely=0.15)
